...
{	
    ...
    public function getMovieInfoByURL($url, $getExtraInfo = false)
    {
	...
	private function getIMDbIdFromSearch($title, $engine = "google"){
		switch ($engine) {
			...
			case "bing":    $nextEngine = "yandex";   break;
			case "yandex":  $nextEngine = FALSE;   break;
			case FALSE:     return NULL;
			default:        return NULL;
		}
		$url = "https://www.${engine}.com/search?q=site:imdb.com+" . rawurlencode($title);
